...
<template>
    <transition name="bounce">
        <div v-show="!showBar" class="fixed top-1 right-2 sticky-1 pt-4 pr-4">
            <button class="inline-flex items-center justify-center bg-green rounded-full shadow-outline hover:bg-dark-green">
                <i @click="showBar = !showBar" class="bx bxs-bell-ring cursor-pointer text-2xl text-white hover:text-yellow m-2"></i>
            </button>
        </div>
    </transition>
    <transition name="slide-fade" :duration="550">
        <div v-show="showBar" class="w-full h-full top-0 overflow-y-auto overflow-x-hidden fixed sticky-0" id="notificationOverlay" ref="notificationOverlay">
            <div id="notification" ref="notification" class="h-full w-full absolute z-99 right-0 h-full overflow-x-hidden shadow">
                <div class="2xl:w-4/12 bg-gray-50 h-screen overflow-y-auto p-8 absolute right-0">
                    <div class="flex items-center justify-between">
                        ...
                        <button role="button" class="rounded-md cursor-pointer" @click="showBar = !showBar"><i class="bx bx-x text-2xl text-black"></i></button>
                    </div>

                    <notification-message iconCls="bxs-heart" dateTime="2022-07-26 22:00:00">This is the content</notification-message>
                    <notification-message iconCls="bx-info-circle" dateTime="2022-07-26 23:30:00">This is the content 2</notification-message>
                    <notification-message>This is the content 3</notification-message>
                    ...
                    <div class="w-full p-3 mt-6 bg-white rounded flex"><div tabindex="0" aria-label="post icon" role="img" class=" focus:outline-none w-8 h-8 border rounded-full border-gray-200 flex items-center justify-center">
                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M4.30325 12.6667L1.33325 15V2.66667C1.33325 2.48986 1.40349 2.32029 1.52851 2.19526C1.65354 2.07024 1.82311 2 1.99992 2H13.9999C14.1767 2 14.3463 2.07024 14.4713 2.19526C14.5963 2.32029 14.6666 2.48986 14.6666 2.66667V12C14.6666 12.1768 14.5963 12.3464 14.4713 12.4714C14.3463 12.5964 14.1767 12.6667 13.9999 12.6667H4.30325ZM5.33325 6.66667V8H10.6666V6.66667H5.33325Z" fill="#4338CA"/>
                            </svg>
                        </div>
                    ...
                    <div class="flex items-center justiyf-between">
                        <hr class="w-full"/>
                        <p class=" focus:outline-none text-sm flex flex-shrink-0 leading-normal px-3 py-16 text-gray-500" tabindex="0">Thats it for now :)</p>
                        <hr class="w-full"/>
                    </div>
                </div>
            </div>
